...
/// </summary>
public class InsertCheckEventArgs : InsertCheckEventArgsBase<MarkerCollection, StyleCollection, IndicatorCollection, Collections.LineCollection, MarginCollection, SelectionCollection, SCNotificationEventArgs, Marker, Style, Indicator, Line, Margin, Selection, Bitmap, Color>
{
    /// <summary>
