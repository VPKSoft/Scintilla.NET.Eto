...
using Indicator = Scintilla.NET.WinForms.Indicator;
using IndicatorCollection = Scintilla.NET.WinForms.IndicatorCollection;
using Line = Scintilla.NET.WinForms.Line;
using LineCollection = Scintilla.NET.WinForms.LineCollection;
using Margin = Scintilla.NET.WinForms.Margin;
using MarginCollection = Scintilla.NET.WinForms.MarginCollection;
using Marker = Scintilla.NET.WinForms.Marker;
using MarkerCollection = Scintilla.NET.WinForms.MarkerCollection;
using NeedShownEventArgs = Scintilla.NET.WinForms.NeedShownEventArgs;
using Selection = Scintilla.NET.WinForms.Selection;
using SelectionCollection = Scintilla.NET.WinForms.SelectionCollection;
using Style = Scintilla.NET.WinForms.Style;
using StyleCollection = Scintilla.NET.WinForms.StyleCollection;
