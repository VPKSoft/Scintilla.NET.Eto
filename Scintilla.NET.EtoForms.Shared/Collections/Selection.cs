...
/// <summary>
/// Represents a selection when there are multiple active selections in a <see cref="WinForms.Scintilla" /> control.
/// </summary>
public class Selection : SelectionBase
{
    ...
    /// </summary>
    /// <param name="scintilla">The <see cref="WinForms.Scintilla" /> control that created this selection.</param>
