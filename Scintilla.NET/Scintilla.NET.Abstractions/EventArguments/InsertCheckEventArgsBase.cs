    ...
    where TColor: struct
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="InsertCheckEventArgsBase{TMarkers, TStyles, TIndicators, TLines, TMargins, TSelections, TMarker, TStyle, TIndicator, TLine, TMargin, TSelection, TBitmap, TColor}" /> class.
    /// </summary>
