...
/// </summary>
public interface IScintillaSelectionCollection<TMarkers, TStyles, TIndicators, TLines, TMargins, TSelections, TMarker, TStyle, TIndicator, TLine, TMargin, TSelection, TBitmap, TColor> : IEnumerable<TSelection>
    ...
    where TColor: struct
{
    ...
    /// </summary>
    /// <returns>The number of selections in the <see cref="IScintillaSelectionCollection{TMarkers, TStyles, TIndicators, TLines, TMargins, TSelections, TMarker, TStyle, TIndicator, TLine, TMargin, TSelection, TBitmap, TColor}" />.</returns>
    int Count { get; }
    ...
    /// <summary>
    /// Gets the <see cref="IScintillaSelectionCollection{TMarkers, TStyles, TIndicators, TLines, TMargins, TSelections, TMarker, TStyle, TIndicator, TLine, TMargin, TSelection, TBitmap, TColor}" /> at the specified zero-based index.
    /// </summary>
    /// <param name="index">The zero-based index of the <see cref="IScintillaSelectionCollection{TMarkers, TStyles, TIndicators, TLines, TMargins, TSelections, TMarker, TStyle, TIndicator, TLine, TMargin, TSelection, TBitmap, TColor}" /> to get.</param>
    /// <returns>The <see cref="IScintillaSelectionCollection{TMarkers, TStyles, TIndicators, TLines, TMargins, TSelections, TMarker, TStyle, TIndicator, TLine, TMargin, TSelection, TBitmap, TColor}" /> at the specified index.</returns>
